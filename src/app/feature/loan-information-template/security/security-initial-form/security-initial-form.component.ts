...
export class SecurityInitialFormComponent implements OnInit {
  ...
  eventLandAndBuildingSecurity($event) {
    ...
    if ($event['isReValuated']) {
      landBuilding.controls[$event['index']]['controls']['revaluationData']['value']['isReValuated'] = Boolean(true);
      landBuilding.controls[$event['index']]['controls']['revaluationData']['value']['reValuatedDv'] = $event['reValuatedDv'];
      landBuilding.controls[$event['index']]['controls']['revaluationData']['value']['reValuatedFmv'] = $event['reValuatedFmv'];
      landBuilding.controls[$event['index']]['controls']['revaluationData']['value']['reValuatedConsideredValue'] = $event['reValuatedConsideredValue'];
    } else {
      landBuilding.controls[$event['index']]['controls']['revaluationData']['value']['isReValuated'] = Boolean(false);
      landBuilding.controls[$event['index']]['controls']['revaluationData']['value']['reValuatedDv'] = 0;
      landBuilding.controls[$event['index']]['controls']['revaluationData']['value']['reValuatedFmv'] = 0;
      landBuilding.controls[$event['index']]['controls']['revaluationData']['value']['reValuatedConsideredValue'] = 0;
    }
    this.updateLandAndBuildingSecurityTotal();
  }
  ...
  updateLandAndBuildingSecurityTotal() {
    ...
    landBuilding['value'].forEach((sec) => {
      if (sec['revaluationData'] !== null && sec['revaluationData']['isReValuated']) {
