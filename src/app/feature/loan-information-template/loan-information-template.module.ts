...
import {FinancialKeysPipe} from '../../@core/pipe/financial-keys.pipe';
...
@NgModule({
    declarations: [...COMPONENTS, CadDocumentUploadComponent, MicroProposalComponent, CommentsComponent, PreviousSecurityComponent,
        CrgMicroComponent, FinancialJsonParserComponent, FinancialUploadViewComponent, FinancialKeysPipe],
    exports: [...COMPONENTS, MicroProposalComponent, CommentsComponent, CrgMicroComponent, FinancialJsonParserComponent, FinancialKeysPipe],
