...
export class CompanyInfoComponent implements OnInit {
  ...
  buildForm() {
    ...
    this.companyInfoFormGroup = this.formBuilder.group({
      ...
      contactName: [(ObjectUtil.isEmpty(this.basicInfo)) ? undefined : this.basicInfo.customerName],
      contactEmail: [(ObjectUtil.isEmpty(this.basicInfo)) ? undefined : this.basicInfo.email],
      contactNumber: [(ObjectUtil.isEmpty(this.basicInfo)) ? undefined : this.basicInfo.contactNumber],
      contactProvince: [(ObjectUtil.isEmpty(this.basicInfo)
          || ObjectUtil.isEmpty(this.basicInfo.province)) ? undefined : this.basicInfo.province],
      contactDistrict: [(ObjectUtil.isEmpty(this.basicInfo)
          || ObjectUtil.isEmpty(this.basicInfo.district)) ? undefined : this.basicInfo.district],
  ...
  onSubmit() {
    ...
    console.log(this.swot.strength, 'this.swot.strength ' );
    ...
    // districts.id = this.companyInfoFormGroup.get('contactDistrict').value;
    // this.customer.district = districts;
    // const municipalityVdcs = new MunicipalityVdc();
    // municipalityVdcs.id = this.companyInfoFormGroup.get('contactMunicipalities').value;
    // this.customer.municipalities = municipalityVdcs;
