...
@Component({
  selector: 'app-gamma-proposal-summary',
  templateUrl: './gamma-proposal-summary.component.html',
  styleUrls: ['./gamma-proposal-summary.component.scss']
})
export class GammaProposalSummaryComponent implements OnInit {
  ...
  ngOnInit() {
    console.log('loanDataHplder', this.loanDataHolder);
