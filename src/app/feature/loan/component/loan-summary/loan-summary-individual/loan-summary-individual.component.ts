...
@Component({
  ...
  templateUrl: './loan-summary-individual.component.html',
  styleUrls: ['./loan-summary-individual.component.scss']
})
export class LoanSummaryIndividualComponent implements OnInit, OnDestroy {
