...
@Component({
    ...
    templateUrl: './limit-pending.component.html',
    styleUrls: ['./limit-pending.component.scss']
})
export class LimitPendingComponent implements OnInit {

    // todo dynamic search obj for approve , pending
    searchObj = {docStatus: 'LIMIT_PENDING'};
    page = 1;
    spinner = false;
    ...
    static loadData(other: LimitPendingComponent) {
        other.spinner = true;
    ...
    ngOnInit() {
        this.userDetail();
        LimitPendingComponent.loadData(this);
    }
