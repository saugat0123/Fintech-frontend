...
export class LetterOfHypothecationPartnershipComponent implements OnInit {
  ...
  setFreeText() {
    const free = {
      sakshiDistrict1: this.letterOfHypothecationPartner.get('sakshiDistrict1').value ? this.letterOfHypothecationPartner.get('sakshiDistrict1').value : '',
      sakshiDistrict2: this.letterOfHypothecationPartner.get('sakshiDistrict2').value ? this.letterOfHypothecationPartner.get('sakshiDistrict2').value : '',
      sakshiMunicipality1: this.letterOfHypothecationPartner.get('sakshiMunicipality1').value ? this.letterOfHypothecationPartner.get('sakshiMunicipality1').value : '',
      sakshiMunicipality2: this.letterOfHypothecationPartner.get('sakshiMunicipality2').value ? this.letterOfHypothecationPartner.get('sakshiMunicipality2').value : '',
      sakshiAge1: this.letterOfHypothecationPartner.get('sakshiAge1').value ? this.letterOfHypothecationPartner.get('sakshiAge1').value : '',
      sakshiAge2: this.letterOfHypothecationPartner.get('sakshiAge2').value ? this.letterOfHypothecationPartner.get('sakshiAge2').value : '',
      sakshiWard1: this.letterOfHypothecationPartner.get('sakshiWard1').value ? this.letterOfHypothecationPartner.get('sakshiWard1').value : '',
      sakshiWard2: this.letterOfHypothecationPartner.get('sakshiWard2').value ? this.letterOfHypothecationPartner.get('sakshiWard2').value : '',
      sakshiName1: this.letterOfHypothecationPartner.get('sakshiName1').value ? this.letterOfHypothecationPartner.get('sakshiName1').value : '',
      sakshiName2: this.letterOfHypothecationPartner.get('sakshiName2').value ? this.letterOfHypothecationPartner.get('sakshiName2').value : '',
      nameOfBankStaff: this.letterOfHypothecationPartner.get('nameOfBankStaff').value ? this.letterOfHypothecationPartner.get('nameOfBankStaff').value : '',
    }
  ...
  submit() {
    ...
    if (!ObjectUtil.isEmpty(this.cadData) && !ObjectUtil.isEmpty(this.cadData.cadFileList)) {
      ...
      if (flag) {
        ...
        // cadFile.initialInformation = JSON.stringify(this.letterOfHypothecationPartner.value);
