...
export class InterestSubsidySanctionLetterComponent implements OnInit {
  ...
  fillForm() {
    ...
    this.form.patchValue({
      ...
      totalInterestRate: this.tempData.interestRate
        ...
        : "",
      marginInPercentage: this.tempData.securities.primarySecurity
        ? this.tempData.securities.primarySecurity[0].marginInPercentageCT
        : "",
      // tslint:disable-next-line:max-line-length
      marginInPercentageMotor: this.tempData.securities.primarySecurity
        ? this.tempData.securities.primarySecurity[0].marginInPercentageMotorCT
        : "",
      // tslint:disable-next-line:max-line-length
      marginInPercentageFoot: this.tempData.securities.primarySecurity
        ? this.tempData.securities.primarySecurity[0].marginInPercentageFootCT
        : "",
  ...
  checkPrimaryConditions() {
    ...
    console.log("primary security: ", this.securityDetails.primarySecurity);
    if (
