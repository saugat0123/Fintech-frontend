...
@Component({
  selector: 'app-kalo-suchi-borrower-partnership',
  templateUrl: './kalo-suchi-borrower-partnership.component.html',
  styleUrls: ['./kalo-suchi-borrower-partnership.component.scss']
})
export class KaloSuchiBorrowerPartnershipComponent implements OnInit {
