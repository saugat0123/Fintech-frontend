...
export class PromisoryNoteInstitutionalComponent implements OnInit {
    ...
    setFreeText() {
        const freeText = {
            ...
            individualRepresentativeAge: this.form.get('individualRepresentativeAge').value ? this.form.get('individualRepresentativeAge').value : '',
    ...
    fillNepaliData() {
        this.form.patchValue({
            ...
            individualRepresentativeAge: this.initialInfoPrint ? this.initialInfoPrint.individualRepresentativeAge : '',
    ...
    buildForm() {
        this.form = this.formBuilder.group({
            ...
            wardNum: [undefined],
            age: [undefined],
            individualRepresentativeAge: [undefined],
