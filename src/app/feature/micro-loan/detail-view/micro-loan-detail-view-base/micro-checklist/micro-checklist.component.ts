...
@Component({
  selector: 'app-micro-checklist',
  templateUrl: './micro-checklist.component.html',
  styleUrls: ['./micro-checklist.component.scss']
})
export class MicroChecklistComponent implements OnInit {
