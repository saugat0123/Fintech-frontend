...
@Component({
    selector: 'app-remit-loan-hierarchy',
    templateUrl: 'remit-loan-heirarchy.component.html',
    styleUrls: ['./remit-loan-hierarchy.component.scss']
})
export class RemitLoanHeirarchyComponent implements OnInit {
    roleList;
    activeCount: number;
